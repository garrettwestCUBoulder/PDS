...
-- -----------------------------------------------------
-- Table `pdsclient`.`companies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pdsclient`.`companies` (
  `company_id` INT NOT NULL AUTO_INCREMENT,
  `company_name` VARCHAR(45) NOT NULL,
  `number_of_employees` INT NULL,
  `authorization_code` VARCHAR(45) NULL,
  address VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS `pdsclient`.`memberships` (
  ...
  CONSTRAINT `user_id_memberships` 
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `pdsclient`.`user_info` (
  ...
  CONSTRAINT `company_id_user_info`
    ...
    REFERENCES `pdsclient`.`companies` (`company_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
